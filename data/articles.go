...
import "github.com/NishadVadgama/go-server-poc/models"
...
var Articles = []models.Article{
	{
	  ...
	  },
	  {
		...
		Tags: []string{"french", "fiction", "english"},
	  },
	  {
		Id: 3,
		...
		Tags: []string{"magical", "history", "french"},
	  },
	  {
		Id: 4,
		...
		Tags: []string{"mystery", "english", "american"},
	  },
	  {
		Id: 5,
		...
		Tags: []string{"crime", "mystery", "love"},
	  },
	  {
		Id: 6,
		...
		Tags: []string{"english", "classic", "american"},
	  },
	  {
		Id: 7,
	  ...
	  },
	  {
		...
		Tags: []string{"american", "history", "magical"},
	  },
	  {
		Id: 10,
		...
		Tags: []string{"fiction", "magical", "history"},
	  },
}